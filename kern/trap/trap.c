...
void idt_init(void) {
     ...
     */
    /* LAB5 YOUR CODE */
    // you should update your lab1 code (just add ONE or TWO lines of code), let user app to use syscall to get the
    // service of ucore so you should setup the syscall interrupt gate in here
